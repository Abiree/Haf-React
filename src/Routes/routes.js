...
import { fetchProjects, fetchPagination, fetchAllProjects } from '../redux/actionCreators/projectCreator';
...
class Routes extends PureComponent {
  ...
  render() {
    ...
    return ( <div>
      <HeaderWithRouter cart={this.props.Cart} user={this.props.User} Login={this.props.Login} logout={this.props.logout} IndividuRegister={this.props.IndividuRegister} OrganisationRegister={this.props.OrganisationRegister}/>
      <TransitionGroup>
