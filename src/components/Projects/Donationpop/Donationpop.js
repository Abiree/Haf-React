  ...
  return(
    ...
    <ModalBody>
      ...
      <div className="input-group mb-3">
          <input className="form-control" type="number" aria-label="Amount (to the nearest dirham)" placeholder="Amount ..." value={input} onInput={e => setInput(e.target.value)}/><span className="input-group-text" style={{"background-color":"#1A75BB","color":"white"}}><b>$</b></span>
